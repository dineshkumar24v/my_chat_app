        ...
        <Form onSubmit={handleSignUpSubmit}>
          <Form.Group controlId="formFileSm" className="mb-3">
            <Form.Label className='text'>
              <img src={uploadImage.url || "./avatar.jpg"} alt='avatar preview' />
              upload an image
            </Form.Label>
            <Form.Control type="file" size="sm" style={{ display: "none" }} onChange={handleuploadImage} />
          </Form.Group>
          <Form.Group className="mb-3">
            <Form.Label>Name</Form.Label>
            <Form.Control type="text" placeholder="display name" onChange={(e) => setsignUpDetails({ ...signUpDetails, name: e.target.value })}/>  
          </Form.Group>
          <Form.Group className="mb-3">
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control type="password" placeholder="password here" onChange={(e) => setsignUpDetails({ ...signUpDetails, password: e.target.value })} />
          </Form.Group>
          <button type="submit" id="signupSubmitBtn" disabled={loading}>{loading ? "Loading" : "Sign Up"}</button>
        </Form>
      </div>
    </div>
  );
